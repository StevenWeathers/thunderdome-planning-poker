...
func Init(config *Config, router *mux.Router, database *db.Database, email *email.Email, cookie *securecookie.SecureCookie, logger *zap.Logger) *api {
	...
	if a.config.FeatureRetro {
		...
		orgRouter.HandleFunc("/{orgId}/departments/{departmentId}/teams/{teamId}/retro-actions", a.userOnly(a.teamAdminOnly(a.handleGetTeamRetroActions()))).Methods("GET")
		...
		orgRouter.HandleFunc("/{orgId}/teams/{teamId}/retro-actions", a.userOnly(a.teamAdminOnly(a.handleGetTeamRetroActions()))).Methods("GET")
		...
		teamRouter.HandleFunc("/{teamId}/retro-actions", a.userOnly(a.teamAdminOnly(a.handleGetTeamRetroActions()))).Methods("GET")
