...
const pt: Translation = {
    ...
    authError: "{friendly|{false:Erro encontrado ao tentar autenticar o guerreiro, true:Erro encontrado ao tentar autenticar o jogador}}",
    ...
    battleRemoveError: "{friendly|{false:Erro ao tentar remover a batalha., true:Erro ao tentar remover o jogo.}}",
    battleRemoveSuccess: "{friendly|{false:Batalha removida com sucesso., true:Jogo removido com sucesso.}}",
    battles: "{friendly|{false:Batalhas, true:Jogos}}",
    battlesActive: "{friendly|{false:Batalhas ativas, true:Jogos ativos}}",
    battlesActiveUsers: "{friendly|{false:Usuários ativos da batalha, true:Usuários ativos do jogo}}",
    ...
    createBattleError: "{friendly|{false:Erro encontrado ao criar batalha, true:Erro encontrado ao criar o jogo}}",
    ...
    customizableBattleOptions: "{friendly|{false:Opções de batalha personalizáveis, true:Opções de jogo personalizáveis}}",
    ...
    deleteBattleConfirmText: "{friendly|{false:Tem certeza de que deseja excluir esta batalha?, true:Tem certeza de que deseja excluir este jogo?}}",
    ...
    flag: "Flag",
    footerAuthoredBy: "é projetado e desenvolvido por {authorOpen}Steven Weathers{authorClose}.",
    footerLicense: "O código fonte é licenciado por {licenseOpen}Apache 2.0{licenseClose}.",
    forgotPassword: "Esqueceu a senha",
    getAlertsError: "Erro ao obter alertas",
    getApikeysError: "Erro ao obter chaves de API",
    getBattleError: "{friendly|{false:Erro ao obter batalha, true:Erro ao obter jogo}}",
    getBattlesError: "{friendly|{false:Erro ao obter batalhas, true:Erro ao obter jogos}}",
    ...
    importJiraXML: "{friendly|{false:Importar planos de XML do Jira, true:Importar histórias de XML do Jira}}",
    ...
    landingFeatureOpenSourceText: "Confira o {repoOpen}repositório no GitHub{repoClose} para solicitar ou contribuir com melhorias, traduções de localidades e correções de bugs ou para {donateOpen}Doar{donateClose}.",
    landingFeatureOpenSourceTitle: "Código aberto",
    landingSalesPitch: "Colaboração de equipe remota com apontamento ágil de histórias em tempo real, sem custo e sem anúncios!",
    landingTitle: "{friendly|{false:Thunderdome é um aplicativo ágil de Planning Poker com um tema divertido, true:Thunderdome é um aplicativo ágil de Planning Poker com um tema divertido}}",
    ...
    logout: "Sair",
    logoutError: "{friendly|{false:Erro encontrado ao tentar sair, true:Erro encontrado ao tentar fazer logout do usuário}}",
    lowercaseEmailsError: "Erro ao tentar normalizar e-mails de usuário em letras minúsculas",
    ...
    mfaSetupIntro: "Digitalize o código QR a seguir com um aplicativo autenticador (como Google Authenticator ou Authy) e insira o token gerado.",
    ...
    oldBattleCleanError: "{friendly|{false:Erro encontrado ao limpar batalhas, true:Erro encontrado ao limpar jogos}}",
    ...
    planLinkPlaceholder: "{friendly|{false:Insira um link para o plano, true:Insira um link para a história}}",
    planName: "{friendly|{false:Nome do Plano, true:Nome da História}}",
    planNamePlaceholder: "{friendly|{false:Digite o nome do plano, true:Digite o nome da história}}",
    ...
    questions: "Perguntas",
    register: "Registrar",
    registerForRetro: "ou {registerOpen}Registre-se{registerClose} para juntar-se à retro",
    registerForStoryboard: "ou {registerOpen}Registre-se{registerClose} para entrar no storyboard",
    ...
    removeBattleConfirmText: "{friendly|{false:Tem certeza de que deseja remover esta batalha?, true:Tem certeza de que deseja remover este jogo?}}",
    ...
    sessionDuplicate: "{friendly|{false:Existe uma sessão de batalha duplicada para o seu ID, true:Existe uma sessão de jogo duplicada para o seu ID}}",
    showActiveBattles: "{friendly|{false:Mostrar batalhas ativas, true:Mostrar jogos ativos}}",
    ...
    teamGetBattlesError: "{friendly|{false:Erro ao obter batalhas de equipe, true:Erro ao obter jogos de equipe}}",
    ...
    type: "Tipo",
    unknownWarrior: "{friendly|{false:Guerreiro Desconhecido, true:Jogador desconhecido}}",
    ...
    verifyAccountFailedError: "Ocorreu um erro ao verificar sua conta, talvez este link tenha expirado ou já tenha sido usado.",
    ...
    warriorInvite: "{friendly|{false:Convide um Guerreiro, true:Convide um jogador}}",
    ...
    battleNamePlaceholder: "{friendly|{false:Digite um nome para a batalha, true:Digite o nome do jogo}}",
    autoFinishVotingLabel: "{friendly|{false:Terminar a votação automaticamente quando todos os jogadores tiverem votado, true:Terminar a votação automaticamente quando todos os jogadores tiverem votado}}",
    ...
    apiKeyStoreWarning: "Por favor, armazene-o em algum lugar seguro porque assim que você sair desta página, não poderemos recuperar ou restaurar este token gerado.",
    ...
    myBattlesError: "{friendly|{false:Erro ao encontrar suas batalhas, true:Erro ao encontrar seus jogos}}",
    warriorJoined: {
    ...
    battleSocketReconnecting: "{friendly|{false:Ooops, recarregando planos de batalha..., true:Ooops, recarregando jogo...}}",
    battleSocketError: "{friendly|{false:Erro ao entrar na batalha atualize e tente novamente., true:Erro ao entrar no jogo atualize e tente novamente.}}",
    battleLoading: "{friendly|{false:Carregando planos de batalha..., true:Carregando jogo...}}",
