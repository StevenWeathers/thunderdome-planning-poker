...
const en: BaseTranslation = {
    ...
    createBattleError: "{friendly|{false:Error encountered creating battle, true:Error encountered creating game}}",
    ...
    logout: "Logout",
    logoutError: "{friendly|{false:Error encountered attempting to logout warrior, true:Error encountered attempting to logout user}}",
    ...
    planLinkPlaceholder: "{friendly|{false:Enter a link to plan, true:Enter a link to story}}",
    ...
    verifyAccountFailedError: "Something went wrong verifying your account, perhaps this link expired or was already used.",
    ...
    battleNamePlaceholder: "{friendly|{false:Enter a battle name, true:Enter a game name}}",
    autoFinishVotingLabel: "{friendly|{false:Auto Finish Voting when all Warriors have voted, true:Auto Finish Voting when all Players have voted}}",
    ...
    myBattlesError: "{friendly|{false:Error finding your battles, true:Error finding your games}}",
    warriorJoined: {
    ...
    battleSocketReconnecting: "{friendly|{false:Ooops reloading Battle Plans..., true:Ooops reloading Game...}}",
    battleSocketError: "{friendly|{false:Error joining battle refresh and try again., true:Error joining game refresh and try again.}}",
    battleLoading: "{friendly|{false:Loading Battle Plans..., true:Loading Game...}}",
