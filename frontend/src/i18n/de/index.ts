...
const de: Translation = {
    ...
    authError: "{friendly|{false:Beim Versuch, den Krieger zu authentifizieren, ist ein Fehler aufgetreten, true:Beim Versuch, den Benutzer zu authentifizieren, ist ein Fehler aufgetreten}}",
    ...
    battleRemoveError: "{friendly|{false:Fehler beim Entfernen der Schlacht aufgetreten., true:Fehler beim Entfernen der Partie aufgetreten.}}",
    battleRemoveSuccess: "{friendly|{false:Schlacht erfolgreich entfernt., true:Partie erfolgreich entfernt.}}",
    battles: "{friendly|{false:Schlachten, true:Partien}}",
    battlesActive: "{friendly|{false:Aktive Schlachten, true:Aktive Partien}}",
    battlesActiveUsers: "{friendly|{false:Aktive Benutzer in der Schlacht, true:Aktive Benutzer in der Partie}}",
    ...
    createBattleError: "{friendly|{false:Fehler beim Erstellen einer Schlacht, true:Fehler beim Erstellen einer Partie}}",
    ...
    footerLicense: "Der Source Code ist lizensiert {licenseOpen}Apache 2.0{licenseClose}.",
    forgotPassword: "Forgot Password",
    getAlertsError: "Error getting alerts",
    getApikeysError: "Error getting apikeys",
    getBattleError: "{friendly|{false:Error getting battle, true:Error getting games}}",
    ...
    importJiraXML: "{friendly|{false:Import plans from Jira XML, true:Import stories from Jira XML}}",
    ...
    landingFeatureOpenSourceText: "Check out the {repoOpen}Github repository{repoClose} to request or contribute enhancements, locale translations and bug fixes or to {donateOpen}Donate{donateClose}.",
    ...
    landingTitle: "{friendly|{false:Thunderdome ist eine Agile Planning Poker App mit einem lustigen Thema, true:Thunderdome is an Agile Planning Poker app}}",
    ...
    logout: "Abmelden",
    logoutError: "{friendly|{false:Fehler beim Abmelden des Kriegers, true:Fehler beim Abmelden des Benutzers}}",
    ...
    planLinkPlaceholder: "{friendly|{false:Link zum Plan eingeben, true:Enter a link to story}}",
    planName: "{friendly|{false:Plan Name, true:Story Name}}",
    planNamePlaceholder: "{friendly|{false:Enter a plan name, true:Enter a story name}}",
    ...
    sessionDuplicate: "{friendly|{false:Es existiert bereits eine Schlacht-Sitzung für Ihre ID, true:Es existiert bereits eine Partie-Sitzung für Ihre ID}}",
    ...
    teamGetBattlesError: "{friendly|{false:Fehler beim Ermitteln der Schlachten des Teams, true:Fehler beim Ermitteln der Partien des Teams}}",
    ...
    type: "Typ",
    unknownWarrior: "{friendly|{false:Unbekannter Krieger, true:Unbekannter Benutzer}}",
    ...
    verifyAccountFailedError: "Bei der Überprüfung des Kontos ist ein Fehler aufgetreten. Möglicherweise ist dieser Link abgelaufen oder wurde bereits verwendet.",
    ...
    warriorCreate: "{friendly|{false:Krieger erstellen, true:Benutzer erstellen}}",
    ...
    battleNamePlaceholder: "{friendly|{false:Name der Schlacht eingeben, true:Name der Partie eingeben}}",
    autoFinishVotingLabel: "{friendly|{false:Sch\u00E4tzung automatisch beenden, wenn alle Krieger gesch\u00E4tzt haben, true:Sch\u00E4tzung automatisch beenden, wenn alle Benutzer gesch\u00E4tzt haben}}",
    ...
    profileErrorUpdating: "Beim Aktualisieren des Profils ist ein Fehler aufgetreten",
    ...
    profileDeleteError: "Es ist ein Fehler beim L\u00F6schen des Kontos aufgetreten.",
    profileTitle: "Profil",
    ...
    apiKeyCreateSuccess: "Neuer Api Key {keyName} erstellt und {onlyNowOpen}dieser wird nur jetzt angezeigt{onlyNowClose}",
    apiKeyStoreWarning: "Bitte den Api Key an einem sicheren Ort aufbewahren, da dieses generierte Token nicht mehr abgerufen oder wiederhergestellt werden kann, sobald diese Seite verlassen wurde.",
    ...
    myBattlesError: "{friendly|{false:Fehler: Keine Schlacht gefunden, true:Fehler: Keine Partie gefunden}}",
    warriorJoined: {
    ...
    battleDeleted: "{friendly|{false:Schlacht gel\u00F6scht, true:Partie gel\u00F6scht}}",
    ...
    battleSocketReconnecting: "{friendly|{false:Ooops Schlachtpl\u00E4ne werden neu geladen..., true:Ooops Partien werden neu geladen...}}",
    battleSocketError: "{friendly|{false:Fehler beim Eintritt in die Schlacht, bitte aktualisieren und nochmals versuchen., true:Fehler beim Eintritt in die Partie, bitte aktualisieren und nochmals versuchen.}}",
    battleLoading: "{friendly|{false:Lade Schlachtpl\u00E4ne..., true:Lade Partien...}}",
