...
const de: Translation = {
    ...
    back: 'Back',
    battleAbandon:
        '{friendly|{false:Schlacht verlassen, true:Partie verlassen}}',
    battleCreate:
        '{friendly|{false:Schlacht erstellen, true:Partie erstellen}}',
    battleDelete: '{friendly|{false:Schlacht löschen, true:Partie löschen}}',
    battleEdit:
        '{friendly|{false:Schlacht bearbeiten, true:Partie bearbeiten}}',
    ...
    organizationGetTeamsError:
        'Fehler beim Ermitteln der Teams des Unternehmens',
    ...
    userEmailPlaceholder:
        'E-Mail-Adresse eines registrierten Benutzers eingeben',
    userName: 'User Name',
    ...
    warriorInvite:
        '{friendly|{false:Krieger einladen, true:Benutzer einladen}}',
    ...
    planSkipped:
        '{friendly|{false:Plan \u00FCbersprungen, true:Story skipped}}',
