...
const ru: Translation = {
    ...
    authError: "{friendly|{false:Error encountered attempting to authenticate warrior, true:Error encountered attempting to authenticate user}}",
    ...
    battleRemoveError: "{friendly|{false:Error attempting to remove battle., true:Error attempting to remove game.}}",
    battleRemoveSuccess: "{friendly|{false:Battle removed successfully., true:Game removed successfully.}}",
    battles: "{friendly|{false:Battles, true:Games}}",
    battlesActive: "{friendly|{false:Active Battles, true:Active Games}}",
    battlesActiveUsers: "{friendly|{false:Active Battle Users, true:Active Story Users}}",
    ...
    createBattleError: "{friendly|{false:Ошибка создания битвы, true:Ошибка создания игры}}",
    ...
    footerLicense: "The source code is licensed {licenseOpen}Apache 2.0{licenseClose}.",
    ...
    landingTitle: "{friendly|{false:Thunderdome is an Agile Planning Poker app with a fun theme, true:Thunderdome is an Agile Planning Poker app}}",
    ...
    logout: "Выйти",
    logoutError: "{friendly|{false:Ошибка при попытке выйти из профиля, true:Error encountered attempting to logout user}}",
    ...
    planLinkPlaceholder: "{friendly|{false:Введите ссылку на задачу, true:Enter a link to story}}",
    planName: "{friendly|{false:Заголовок задачи, true:Story Name}}",
    planNamePlaceholder: "{friendly|{false:Введите заголовок задачи, true:Enter a story name}}",
    ...
    sessionDuplicate: "{friendly|{false:Duplicate battle session exists for your ID, true:Duplicate game session exists for your ID}}",
    ...
    teamGetBattlesError: "{friendly|{false:Error getting team battles, true:Error getting team games}}",
    ...
    type: "Type",
    unknownWarrior: "{friendly|{false:Неизвестный участник, true:Unknown Player}}",
    ...
    battleNamePlaceholder: "{friendly|{false:Введите название битвы, true:Введите название игры}}",
    autoFinishVotingLabel: "{friendly|{false:Автозавершение голосования когда все проголосовали, true:Auto Finish Voting when all Players have voted}}",
    ...
    apiKeyStoreWarning: "Please store it somewhere safe because as soon as you navigate away from this page, we will not be able to retrieve or restore this generated token.",
    ...
    myBattlesError: "{friendly|{false:Ошибка поиска ваших битв, true:Ошибка поиска ваших игр}}",
    warriorJoined: {
    ...
    battleSocketReconnecting: "{friendly|{false:Упс перезагрузка списка задач..., true:Ooops reloading Game...}}",
    battleSocketError: "{friendly|{false:Ошибка: обновите страницу или попробуйте позже., true:Error joining game refresh and try again.}}",
    battleLoading: "{friendly|{false:Загрузка списка задач..., true:Loading Game...}}",
