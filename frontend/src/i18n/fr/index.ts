...
const fr: Translation = {
    ...
    authError: "{friendly|{false:Erreur lors de l'authentification du guerrier, true:Erreur lors de l'authentification du joueur}}",
    autoFinishVoting: "Auto Finish Voting",
    avatarAltText: "Emplacement Avatar",
    back: "Back",
    battleAbandon: "{friendly|{false:Abandonner la bataille, true:Abandonner le Jeu}}",
    battleCreate: "{friendly|{false:Créer la bataille, true:Créer le Jeu}}",
    battleDelete: "{friendly|{false:Supprimer la bataille, true:Supprimer le Jeu}}",
    ...
    battleRemoveError: "{friendly|{false:Erreur lors de la suppression de la bataille., true:Erreur lors de la suppression du jeu.}}",
    battleRemoveSuccess: "{friendly|{false:Bataille supprimée avec succès., true:Jeu supprimé avec succès.}}",
    battles: "{friendly|{false:Batailles, true:Jeux}}",
    battlesActive: "{friendly|{false:Batailles actives, true:Jeux actifs}}",
    battlesActiveUsers: "{friendly|{false:Utilisateurs de la Bataille Active, true:Utilisateurs du jeu actif}}",
    ...
    createBattleError: "{friendly|{false:Erreur lors de la création de la bataille, true:Erreur lors de la création du jeu}}",
    ...
    customizableBattleOptions: "{friendly|{false:Customizable Battle Options, true:Customizable Game Options}}",
    ...
    deleteBattleConfirmText: "{friendly|{false:Are you sure you want to delete this battle?, true:Are you sure you want to delete this game?}}",
    deleteBattleError: "{friendly|{false:error deleting battle, true:error deleting game}}",
    ...
    flag: "Flag",
    footerAuthoredBy: "is designed and developed by {authorOpen}Steven Weathers{authorClose}.",
    footerLicense: "Le code source est sous licence {licenseOpen}Apache 2.0{licenseClose}.",
    forgotPassword: "Forgot Password",
    getAlertsError: "Error getting alerts",
    getApikeysError: "Error getting apikeys",
    getBattleError: "{friendly|{false:Error getting battle, true:Error getting game}}",
    getBattlesError: "{friendly|{false:Error getting battles, true:Error getting games}}",
    ...
    importCsv: "{friendly|{false:Import plans from a CSV file, true:Import stories from a CSV file}}",
    importCsvFileBadFileTypeError: "Error bad file type",
    importCsvFileReadFileError: "Error reading file",
    importJiraXML: "{friendly|{false:Importer les plans depuis un XML Jira, true:Importer les stories depuis un XML Jira}}",
    ...
    landingFeatureOpenSourceText: "Allez voir {repoOpen}le repository{repoClose} pour demander ou contribuer à des améliorations, traductions et corrections de bugs ou pour {donateOpen}Donner{donateClose}.",
    landingFeatureOpenSourceTitle: "Open Source",
    landingSalesPitch: "Remote team collaboration with realtime agile story pointing, no cost and ad free!",
    landingTitle: "{friendly|{false:Thunderdome est une app de Planning Poker Agile avec un thème fun, true:Thunderdome est une app de Planning Poker Agile}}",
    ...
    logoutError: "{friendly|{false:Erreur lors de la tentative de déconnexion du guerrier, true:Erreur lors de la tentative de déconnexion de l'utilisateur}}",
    ...
    mfaSetupIntro: "Scan the following QR code with an Authenticator Application (such as Google Authenticator or Authy) and enter the generated token.",
    ...
    oldBattleCleanError: "{friendly|{false:Error encountered cleaning battles, true:Error encountered cleaning games}}",
    ...
    planLink: "Lien",
    planLinkInvalid: "Le lien n'est pas une URL absolue valide, ex. inclut le protocole (HTTP/HTTPS)",
    planLinkPlaceholder: "{friendly|{false:Entrer un lien pour le plan, true:Entrer un lien pour la story}}",
    planName: "{friendly|{false:Nom du plan, true:Nom de la Story}}",
    planNamePlaceholder: "{friendly|{false:Entrer un nom de plan, true:Entrer un nom de story}}",
    ...
    registerForRetro: "or {registerOpen}Register{registerClose} to join the Retro",
    registerForStoryboard: "or {registerOpen}Register{registerClose} to join the Storyboard",
    ...
    removeBattleConfirmText: "{friendly|{false:Are you sure you want to remove this battle?, true:Are you sure you want to remove this game?}}",
    ...
    sessionDuplicate: "{friendly|{false:Un doublon de bataille existe pour votre ID, true:Un doublon de jeu existe pour votre ID}}",
    showActiveBattles: "{friendly|{false:Show Active Battles, true:Show Active Games}}",
    ...
    teamGetBattlesError: "{friendly|{false:Erreur lors de la récupération des batailles de l'équipe, true:Erreur lors de la récupération des jeux de l'équipe}}",
    ...
    verifyAccountFailedError: "Quelque chose s'est mal passé pendant la vérification de votre compte, peut-être ce lien a expiré ou a déjà été utilisé.",
    ...
    warriorCreate: "{friendly|{false:Créer un Guerrier, true:Créer un Utilisateur}}",
    warriorInvite: "{friendly|{false:Inviter un Guerrier, true:Inviter un Joueur}}",
    ...
    battleNamePlaceholder: "{friendly|{false:Entrer le nom de la bataille, true:Entrer un nom de jeu}}",
    autoFinishVotingLabel: "{friendly|{false:Terminer automatiquement le vote quand tous les Guerriers ont voté, true:Terminer automatiquement le vote quand tous les Utilisateurs ont voté}}",
    ...
    deleteAccountWarningStatement: "Etes-vous sûr de vouloir supprimer votre compte, cette action ne peut pas être annulée.",
    deleteConfirmButton: "Confirmer la suppression",
    apiKeyNameInvalid: "Entrer un nom pour la clé svp",
    apiKeyCreateSuccess: "La nouvelle clé API {keyName} est créée et {onlyNowOpen}sera affichée uniquement maintenant{onlyNowClose}",
    apiKeyStoreWarning: "Merci de l'enregistrer dans un endroit sûr car dès que vous quitterez cette page, nous ne pourrons plus retrouver ou restaurer ce token généré.",
    ...
    myBattlesError: "{friendly|{false:Erreur pour trouver vos batailles, true:Erreur pour trouver vos jeux}}",
    warriorJoined: {
    ...
    battleSocketReconnecting: "{friendly|{false:Ooops, rechargement des Plans de Bataille..., true:Ooops, rechargement du Jeu...}}",
    battleSocketError: "{friendly|{false:Erreur pour joindre la bataille rafraîchir et réessayer., true:Erreur pour joindre le jeu rafraîchir et réessayer.}}",
    battleLoading: "{friendly|{false:Chargement des Plans de Bataille..., true:Chargement du Jeu...}}",
