...
const it: Translation = {
    ...
    appName: 'Thunderdome',
    appPreviewAlt:
        'Anteprima di Thunderdome, Esperienza UI Agile Planning Poker',
    ...
    back: 'Indietro',
    battleAbandon:
        '{friendly|{false:Abbandona Battaglia, true:Abbandona Gioco}}',
    ...
    inviteLinkCopyFailure:
        'Impossibile copiare il link di invito negli appunti',
    ...
    joinStoryboardError:
        "Errore nell'unirsi al storyboard, ricarica e riprova.",
    landingCountries: {
    ...
    removeRetroConfirmText:
        'Sei sicuro di voler rimuovere questa retrospettiva?',
    ...
    retroAddError:
        'Errore durante il tentativo di aggiungere la retrospettiva.',
    ...
    retroJoinError:
        "Errore nell'unirsi alla retrospettiva, ricarica e riprova.",
    ...
    votePhaseDescription:
        'Vota per i gruppi che vorresti discutere maggiormente',
    ...
    passwordUpdateError:
        'Errore riscontrato tentativo di aggiornare la password',
    profileDeleteError:
    ...
    createBattle:
        '{friendly|{false:Crea una Battaglia, true:Crea una partita}}',
    countPlansPointed: {
