...
const it: Translation = {
    ...
    authError: "{friendly|{false:Errore durante l'autenticazione del guerriero, true:Errore durante l'autenticazione del giocatore}}",
    ...
    battleJoin: "{friendly|{false:Entra in Battaglia, true:Unisciti alla partita}}",
    battleName: "{friendly|{false:Nome Battaglia, true:Nome partita}}",
    battleRemoveError: "{friendly|{false:Errore durante l'eliminazione della Battaglia., true:Errore durante la rimozione della partita.}}",
    battleRemoveSuccess: "{friendly|{false:Battaglia eliminata con successo., true:Partita rimossa con successo.}}",
    battles: "{friendly|{false:Battaglie, true:Partite}}",
    battlesActive: "{friendly|{false:Battaglie attive, true:Partite attive}}",
    battlesActiveUsers: "{friendly|{false:Guerrieri attivi nelle Battaglie, true:Utenti attivi in partite}}",
    ...
    createBattleError: "{friendly|{false:Si è verificato un errore durante la creazione della battaglia, true:Errore durante la creazione della partita}}",
    ...
    customizableBattleOptions: "{friendly|{false:Opzioni di Battaglia personalizzabili, true:Opzioni di gioco personalizzabili}}",
    ...
    deleteBattleConfirmText: "{friendly|{false:Sei sicuro di voler eliminare questa Battaglia?, true:Sei sicuro di voler eliminare questa partita?}}",
    deleteBattleError: "{friendly|{false:Errore durante l'eliminazione della Battaglia, true:Errore durante l'eliminazione della partita}}",
    ...
    flag: "Segnalazione",
    footerAuthoredBy: "è progettato e sviluppato da {authorOpen}Steven Weathers{authorClose}.",
    footerLicense: "Il codice sorgente è concesso in licenza {licenseOpen}Apache 2.0{licenseClose}.",
    forgotPassword: "Password Dimenticata",
    getAlertsError: "Errore durante il recupero degli avvisi",
    getApikeysError: "Errore durante il recupero delle chiavi API",
    getBattleError: "{friendly|{false:Errore durante la visualizzazione della Battaglia, true:Errore durante il recupero delle partite}}",
    getBattlesError: "{friendly|{false:Errore durante la visualizzazione delle Battaglie, true:Errore durante il recupero delle partite}}",
    ...
    importCsv: "{friendly|{false:Importa piani da un file CSV, true:Import stories from a CSV file}}",
    importCsvFileBadFileTypeError: "Errore Tipo di file cattivo",
    importCsvFileReadFileError: "File di lettura degli errori",
    importJiraXML: "{friendly|{false:Importa piani da Jira XML, true:Importa storie da Jira XML}}",
    ...
    landingFeatureOpenSourceText: "Dai un'occhiata al{repoOpen}Github repository{repoClose}per richiedere o contribuire a miglioramenti, traduzioni locali e correzioni di bug o a{donateOpen}Donate{donateClose}.",
    landingFeatureOpenSourceTitle: "Open source",
    landingSalesPitch: "Collaborazione remota tra team con puntamento delle storie agile in tempo reale, senza costi e senza pubblicità!",
    landingTitle: "{friendly|{false:Thunderdome è un'app Agile Planning Poker con un tema divertente, true:Thunderdome è un'app di Agile Planning Poker}}",
    ...
    logoutError: "{friendly|{false:Si è verificato un errore durante il logout del guerriero, true:Si è verificato un errore durante il logout dell'utente}}",
    lowercaseEmailsError: "Errore durante la conversione delle email degli utenti in minuscolo",
    lowercaseEmailsSuccess: "Email degli utenti convertite in minuscolo con successo",
    ...
    mfaSetupIntro: "Scansiona il seguente codice QR con un'applicazione Autenticatore (come Google Autenticatore o Authy) e inserisci il token generato.",
    ...
    oldBattleCleanError: "{friendly|{false:Errore durante la pulizia delle Battaglie vecchie, true:Errore durante la pulizia delle partite}}",
    ...
    planLinkPlaceholder: "{friendly|{false:Inserisci un link al piano, true:Inserisci un link alla storia}}",
    planName: "{friendly|{false:Nome Piano, true:Nome Storia}}",
    planNamePlaceholder: "{friendly|{false:Inserisci un nome per il piano, true:Inserisci un nome per la storia}}",
    ...
    questions: "Domande",
    register: "Registrati",
    registerForRetro: "o {registerOpen}Registrati{registerClose} per partecipare al retro",
    registerForStoryboard: "o {registerOpen}Registrati{registerClose} per partecipare allo storyboard",
    ...
    removeBattleConfirmText: "{friendly|{false:Sei sicuro di voler rimuovere questa Battaglia?, true:Sei sicuro di voler rimuovere questa partita?}}",
    ...
    sessionDuplicate: "{friendly|{false:Esiste già una sessione di battaglia duplicata per il tuo ID, true:Esiste una sessione di gioco duplicata per il tuo ID}}",
    showActiveBattles: "{friendly|{false:Mostra Battaglie Attive, true:Mostra partite attive}}",
    ...
    teamGetBattlesError: "{friendly|{false:Errore durante la visualizzazione delle Battaglie del team, true:Errore durante il recupero delle partite del team}}",
    ...
    type: "Tipo",
    unknownWarrior: "{friendly|{false:Guerriero sconosciuto, true:Giocatore sconosciuto}}",
    ...
    verifyAccountFailedError: "Qualcosa è andato storto per verificare il tuo account, forse questo link è scaduto o è già stato utilizzato.",
    ...
    warriorInvite: "{friendly|{false:Invita un Guerriero, true:Invita un giocatore}}",
    ...
    battleNamePlaceholder: "{friendly|{false:Inserisci un nome per la battaglia, true:Inserisci il nome della partita}}",
    autoFinishVotingLabel: "{friendly|{false:Termina automaticamente il voto quando tutti i guerrieri hanno votato, true:Termina automaticamente il voto quando tutti i giocatori hanno votato}}",
    ...
    apiKeyStoreWarning: "Ti preghiamo di memorizzare un posto sicuro perché non appena navighi da questa pagina, non saremo in grado di recuperare o ripristinare questo token generato.",
    ...
    myBattlesError: "{friendly|{false:Si è verificato un errore nel trovare le tue battaglie, true:Errore durante la ricerca delle tue partite}}",
    warriorJoined: {
    ...
    battleDeleted: "{friendly|{false:Battaglia eliminata, true:Partita eliminata}}",
    ...
    battleSocketReconnecting: "{friendly|{false:Ops, ricarico i Piani di Battaglia..., true:Ops, caricamento della partita...}}",
    battleSocketError: "{friendly|{false:Errore durante la connessione alla Battaglia ricarica la pagina e riprova., true:Errore durante la connessione alla partita ricaricare e riprovare.}}",
    battleLoading: "{friendly|{false:Caricamento Piani di Battaglia..., true:Caricamento partita...}}",
    ...
    enableBattleNotifications: "{friendly|{false:Enable battle notifications, true:Enable game notifications}}",
    avatar: "Avatar",
