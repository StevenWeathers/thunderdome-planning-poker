...
<div class="flex flex-wrap items-stretch w-full">
    <input
        class="flex-shrink flex-grow flex-auto leading-normal w-px flex-1 border h-10 border-gray-400 rounded rounded-r-none px-3"
        type="text"
    ...
    <div class="flex -mr-px">
        <SolidButton
            ...
            additionalClasses="flex items-center leading-normal rounded-l-none border-blue-800 px-3 whitespace-no-wrap text-sm"
        >
