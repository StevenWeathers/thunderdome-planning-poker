...
test.describe('The Admin Department Page', () => {
    test.describe('Unauthenticated user', () => {
        test('redirects to login', async ({page}) => {
            ...
            await adminPage.goto('bbaf82ef-a2d3-4e9a-b824-5e56a03ac3aa', 'bbaf82ef-a2d3-4e9a-b824-5e56a03ac3aa')
    ...
    test.describe('Admin User', () => {
        test('loads Department page', async ({registeredPage, adminPage}) => {
            ...
            const dept = await registeredPage.createOrgDepartment(org.id, testDeptName)
