...
test.describe('Team page', () => {
    ...
    test('Registered user loads organization team page', async ({registeredPage}) => {
        const testTeamName = 'E2E TEST TEAM'
    ...
    test('Registered user loads department team page', async ({registeredPage}) => {
        const testTeamName = 'E2E TEST TEAM'
    ...
    test('can add user to team', async ({registeredPage}) => {
        ...
        await expect(teamPage.page.locator('[data-testid="user-email"]', {
