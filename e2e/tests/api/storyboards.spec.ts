...
test.describe("Storyboard API", {tag: ["@api", "@storyboard"]}, () => {
    ...
    test("POST /teams/{teamId}/users/{userId}/storyboards creates storyboard", {tag: ['@team']}, async ({
                                                                                                            request,
                                                                                                            registeredApiUser,
                                                                                                        }) => {
    ...
    test.only("POST /storyboards/{storyboardId}/goals creates storyboard goal", async ({
                                                                                           request,
                                                                                           registeredApiUser,
                                                                                       }) => {
        ...
        expect(storyboardWithGoal.data).toContainEqual(
            expect.objectContaining({
