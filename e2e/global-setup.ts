...
async function globalSetup(config: FullConfig) {
    ...
    await adminLoginPage.page.context().storageState({path: 'storage/adminStorageState.json'});
    ...
    await userVerifiedPage.page.context().storageState({path: 'storage/verifiedStorageState.json'});
