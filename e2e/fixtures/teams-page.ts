...
export class TeamsPage {
    ...
    constructor(page: Page) {
        this.page = page;
        this.createOrgButton = page.locator('button', {hasText: 'Create Organization'});
        this.createTeamButton = page.locator('button', {hasText: 'Create Team'});
        this.organizationNameField = page.locator('form[name="createOrganization"] [name="organizationName"]');
