...
export class StoryboardsPage {
    ...
    constructor(page: Page) {
        this.page = page;
        this.storyboardNameFormField = page.locator('form[name="createStoryboard"] [name="storyboardName"]');
        this.storyboardCardName = page.locator('[data-testid="storyboard-name"]');
    }
