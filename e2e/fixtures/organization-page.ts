...
export class OrganizationPage {
    ...
    constructor(page: Page) {
        this.page = page;
        this.createDepartmentButton = page.locator('button', {hasText: 'Create Department'});
        this.createTeamButton = page.locator('button', {hasText: 'Create Team'});
        this.departmentNameFormField = page.locator('form[name="createDepartment"] [name="departmentName"]');
