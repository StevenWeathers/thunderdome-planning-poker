...
const seed = async (pool) => {
    ...
    await pool.query(`INSERT INTO api_keys (id, user_id, name, active) VALUES ($1, $2, $3, TRUE);`,
        ["8MenPkY8.cd737cbc4bdca1838bdcf1685b00a9a778261255c10193714d9ba1630b55b63c", id, "test apikey"]
    )
