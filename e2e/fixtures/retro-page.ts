...
export class RetroPage {
    ...
    constructor(page: Page) {
        ...
        this.retroDeleteBtn = page.getByRole('button', {name: 'Delete Retro'})
        ...
        this.retroNextPhaseBtn = page.getByRole('button', {name: "Next Phase"})
        this.retroPhasePrimeDirectiveBtn = page.getByRole('button', {name: 'Prime Directive'})
        this.retroPhaseBrainstormBtn = page.getByRole('button', {name: 'Brainstorm'})
        this.retroPhaseGroupBtn = page.getByRole('button', {name: 'Group'})
        this.retroPhaseVoteBtn = page.getByRole('button', {name: 'Vote'})
        this.retroPhaseActionItemsBtn = page.getByRole('button', {name: 'Action Items'})
