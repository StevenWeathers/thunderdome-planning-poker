...
<div class="dark:text-gray-200">
  ...
  <h2 class="py-2 text-xl">General Terms</h2>
  <p class="py-4">
    By accessing and placing an order with Thunderdome, you confirm that you are
    ...
    email or other type of communication between you and Thunderdome.
  </p>
  <p class="py-4">
    ...
    to use, the materials on this site, even if Thunderdome team or an
  ...
  <h2 class="py-2 text-xl">License</h2>
  <p class="py-4">
    Thunderdome grants you a revocable, non-exclusive, non-transferable, limited
    license to download, install and use the app strictly in accordance with the
  ...
  <p class="py-4">
    ...
    "our"), the provider of the Thunderdome website and the services accessible
    from the Thunderdome website (which are collectively referred to in these
    Terms & Conditions as the "Thunderdome Service").
  </p>
  <p class="py-4">
  ...
  <ul class="space-y-1 list-disc list-inside">
    ...
    <li>
      ...
      refers to Thunderdome, that is responsible for your information under this
      Terms & Conditions.
    </li>
    <li>
    ...
    <li>
      ...
      any other device that can be used to visit Thunderdome and use the
      services.
    </li>
    <li>
      Service: refers to the service provided by Thunderdome as described in the
    ...
    <li>Website: Thunderdome's site, which can be accessed via this URL:</li>
    <li>
  ...
  <h2 class="py-2 text-xl">Restrictions</h2>
  <p class="py-4">You agree not to, and you will not permit others to:</p>
  <ul class="space-y-1 list-disc list-inside">
    <li>
  ...
  <h2 class="py-2 text-xl">Return and Refund Policy</h2>
  <p class="py-4">
    Thanks for shopping at Thunderdome. We appreciate the fact that you like to
  ...
  <h2 class="py-2 text-xl">Your Suggestions</h2>
  <p class="py-4">
    Any feedback, comments, ideas, improvements or suggestions (collectively,
    "Suggestions") provided by you to Thunderdome with respect to the app shall
    remain the sole and exclusive property of Thunderdome.
  </p>
  <p class="py-4">
    Thunderdome shall be free to use, copy, modify, publish, or redistribute the
  ...
  <p class="py-4">
    ...
    being used. By using our app, registering an account, or making a purchase,
  ...
  <p class="py-4">
    ...
    and functionality of our app but are non-essential to their use. However,
  ...
  <h2 class="py-2 text-xl">Changes To Our Terms & Conditions</h2>
  <p class="py-4">
    ...
    inform Thunderdome when you stop using the Service. You acknowledge and
    agree that if Thunderdome disables access to your account, you may be
  ...
  <h2 class="py-2 text-xl">Modifications to Our app</h2>
  <p class="py-4">
  ...
  <h2 class="py-2 text-xl">Updates to Our app</h2>
  <p class="py-4">
  ...
  <p class="py-4">
    ...
    app. You agree that Thunderdome has no obligation to (i) provide any
  ...
  <p class="py-4">
    You acknowledge and agree that Thunderdome shall not be responsible for any
    ...
    aspect thereof. Thunderdome does not assume and shall not have any liability
  ...
  <h2 class="py-2 text-xl">Term and Termination</h2>
  <p class="py-4">
  ...
  <p class="py-4">
    ...
    Thunderdome, in the event that you fail to comply with any provision of this
    Agreement. You may also terminate this Agreement by deleting the app and all
  ...
  <p class="py-4">
    Termination of this Agreement will not limit any of Thunderdome's rights or
  ...
  <h2 class="py-2 text-xl">Copyright Infringement Notice</h2>
  <p class="py-4">
    If you are a copyright owner or such owner’s agent and believe any material
    on our app constitutes an infringement on your copyright, please contact us
  ...
  <h2 class="py-2 text-xl">Indemnification</h2>
  <p class="py-4">
    ...
    to or arising out of your: (a) use of the app; (b) violation of this
    Agreement or any law or regulation; or (c) violation of any right of a third
    party.
  </p>

  <h2 class="py-2 text-xl">No Warranties</h2>
  <p class="py-4">
    ...
    representation of any kind that the app will meet your requirements, achieve
  ...
  <p class="py-4">
    ...
    the app will be uninterrupted or error-free; (iii) as to the accuracy,
    reliability, or currency of any information or content provided through the
    app; or (iv) that the app, its servers, the content, or e-mails sent from or
    on behalf of Thunderdome are free of viruses, scripts, trojan horses, worms,
  ...
  <h2 class="py-2 text-xl">Limitation of Liability</h2>
  <p class="py-4">
  ...
  <p class="py-4">
    ...
    of or in any way related to the use of or inability to use the app,
  ...
  <h2 class="py-2 text-xl">Severability</h2>
  <p class="py-4">
  ...
  <p class="py-4">
    ...
    published by Thunderdome on the Services, shall constitute the entire
    agreement between you and Thunderdome concerning the Services. If any
    ...
    Thunderdome's failure to assert any right or provision under this Agreement
    shall not constitute a waiver of such right or provision. YOU AND
    Thunderdome AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR RELATED TO THE
  ...
  <h2 class="py-2 text-xl">Waiver</h2>
  <p class="py-4">
  ...
  <h2 class="py-2 text-xl">Amendments to this Agreement</h2>
  <p class="py-4">
    Thunderdome reserves the right, at its sole discretion, to modify or replace
  ...
  <p class="py-4">
    By continuing to access or use our app after any revisions become effective,
    you agree to be bound by the revised terms. If you do not agree to the new
    terms, you are no longer authorized to use Thunderdome.
  </p>

  <h2 class="py-2 text-xl">Entire Agreement</h2>
  <p class="py-4">
  ...
  <p class="py-4">
    ...
    use or purchase other Thunderdome's services, which Thunderdome will provide
    to you at the time of such use or purchase.
  </p>

  <h2 class="py-2 text-xl">Updates to Our Terms</h2>
  <p class="py-4">
  ...
  <h2 class="py-2 text-xl">Intellectual Property</h2>
  <p class="py-4">
    ...
    Thunderdome, its licensors or other providers of such material and are
  ...
  <h2 class="py-2 text-xl">Agreement to Arbitrate</h2>
  <p class="py-4">
  ...
  <h2 class="py-2 text-xl">Notice of Dispute</h2>
  <p class="py-4">
    ...
    email to: . Thunderdome will send any Notice of Dispute to you by mail to
    your address if we have it, or otherwise to your email address. You and
    Thunderdome will attempt to resolve any dispute through informal negotiation
    within sixty (60) days from the date the Notice of Dispute is sent. After
    sixty (60) days, you or Thunderdome may commence arbitration.
  </p>

  <h2 class="py-2 text-xl">Binding Arbitration</h2>
  <p class="py-4">
  ...
  <h2 class="py-2 text-xl">Submissions and Privacy</h2>
  <p class="py-4">
    ...
    to you whatsoever. Thunderdome and its affiliates shall have no obligations
  ...
  <h2 class="py-2 text-xl">Promotions</h2>
  <p class="py-4">
  ...
  <h2 class="py-2 text-xl">Typographical Errors</h2>
  <p class="py-4">
  ...
  <h2 class="py-2 text-xl">Miscellaneous</h2>
  <p class="py-4">
    ...
    writing and signed by an authorized representative of Thunderdome.
    Thunderdome will be entitled to injunctive or other equitable relief
    (without the obligations of posting any bond or surety) in the event of any
    breach or anticipatory breach by you. Thunderdome operates and controls the
    Thunderdome Service from its offices in . The Service is not intended for
    distribution to or use by any person or entity in any jurisdiction or
    country where such distribution or use would be contrary to law or
    regulation. Accordingly, those persons who choose to access the Thunderdome
    ...
    Thunderdome Privacy Policy) contains the entire understanding, and
    supersedes all prior understandings, between you and Thunderdome concerning
  ...
  <h2 class="py-2 text-xl">Disclaimer</h2>
  <p class="py-4">
    Thunderdome is not responsible for any content, code or any other
    imprecision.
  </p>
  <p class="py-4">Thunderdome does not provide warranties or guarantees.</p>
  <p class="py-4">
  ...
  <p class="py-4">
    ...
    express or implied. Thunderdome is a distributor and not a publisher of the
    content supplied by third parties; as such, Thunderdome exercises no
    ...
    service or merchandise provided through or accessible via the Thunderdome
    Service. Without limiting the foregoing, Thunderdome specifically disclaims
    all warranties and representations in any content transmitted on or in
    connection with the Thunderdome Service or on sites that may appear as links
    on the Thunderdome Service, or in the products provided as a part of, or
    otherwise in connection with, the Thunderdome Service, including without
    limitation any warranties of merchantability, fitness for a particular
    purpose or non-infringement of third party rights. No oral advice or written
    information given by Thunderdome or any of its affiliates, employees,
    ...
    limiting the foregoing, Thunderdome does not warrant that the Thunderdome
