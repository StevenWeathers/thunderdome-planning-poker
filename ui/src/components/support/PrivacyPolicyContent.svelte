...
<div class="dark:text-gray-200">
  ...
  <p class="py-4">
    Thunderdome (“we,” “our,” or “us”) is committed to protecting your privacy.
    This Privacy Policy explains how your personal information is collected,
    used, and disclosed by Thunderdome.
  </p>
  <p class="py-4">
    ...
    accessing or using our Service, you signify that you have read, understood,
  ...
  <div class="mb-4">
    ...
    <ul class="space-y-1 list-disc list-inside">
      ...
      <li>
        ...
        use the Thunderdome Service to manage the relationships with your
  ...
  <p class="py-4">
    Thunderdome will collect End User Data necessary to provide the Thunderdome
  ...
  <p class="py-4">
    Thunderdome will collect personal information that you submit to us. We may
  ...
  <p class="py-4">
    ...
    of the purposes stated in this Policy. Note: If at any time you would like
  ...
  <p class="py-4">
    ...
    obligations, we’ll either remove it from our systems or depersonalize it so
  ...
  <p class="py-4">
    ...
    Thunderdome or guarantee that your information on the Service may not be
  ...
  <p class="py-4">
    Thunderdome is incorporated in United States. Information collected via our
  ...
  <p class="py-4">
    ...
    Thunderdome collects depend on your relationship with Thunderdome. Personnel
    may update or correct their information as detailed in our internal company
    employment policies.
  </p>
  <p class="py-4">
    ...
    (subject to the following paragraph), by cancelling your account. Such
  ...
  <p class="py-4">
    ...
    is controlled by or is under common control with Thunderdome, whether by
    ownership or otherwise. Any information relating to you that we provide to
    our Corporate Affiliates will be treated by those Corporate Affiliates in
    accordance with the terms of this Privacy Policy.
  </p>

  <h2 class="py-2 text-xl">Governing Law</h2>
  <p class="py-4">
    This Privacy Policy is governed by the laws of United States without regard
  ...
  <p class="py-4">
    ...
    govern this Agreement and your use of the app. Your use of the app may also
    be subject to other local, state, national, or international laws.
  </p>
  <p class="py-4">
    By using Thunderdome or contacting us directly, you signify your acceptance
    ...
    the website, direct engagement with us, or following the posting of changes
  ...
  <p class="py-4">
    ...
    for breach. Beyond these facts it's simply the right thing to do. At
    Thunderdome we strongly believe that your data privacy is very important and
    we already have solid security and privacy practices in place that go beyond
