...
<Modal closeModal={toggleCheckin} widthClasses="md:w-4/5 lg:w-3/4 xl:w-2/3 max-w-6xl" ariaLabel={$LL.modalTeamCheckin()}>
    <!-- Header -->
    <div class="py-5 mb-8">
      <div class="flex items-center space-x-4">
        ...
        <div>
          <h1 class="text-3xl font-bold text-slate-900 dark:text-white font-rajdhani tracking-wide">
            Team Check-in
          </h1>
    ...
    <form onsubmit={onSubmit} name="teamCheckin" class="space-y-6">
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
            ...
            <div class="p-6">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-3">
                  <div class="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider font-rajdhani">
                    {$LL.yesterday()}
                  </div>
                  <div class="text-slate-700 dark:text-slate-300 bg-slate-50 dark:bg-slate-700 rounded-lg p-4 prose prose-sm max-w-none">
                ...
                <div class="space-y-3">
                  <div class="text-xs font-medium text-red-500 dark:text-red-400 uppercase tracking-wider font-rajdhani flex items-center space-x-1">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span>{$LL.blockers()}</span>
                  </div>
                  <div class="text-slate-700 dark:text-slate-300 bg-red-50 dark:bg-red-900/20 rounded-lg p-4 prose prose-sm max-w-none border border-red-100 dark:border-red-800">
                    {@html lastCheckin.blockers || '<span class="text-slate-400 italic">No blockers</span>'}
                  </div>
                </div>
                <div class="space-y-3">
                  <div class="text-xs font-medium text-emerald-600 dark:text-emerald-400 uppercase tracking-wider font-rajdhani flex items-center space-x-1">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                    </svg>
                    <span>{$LL.discuss()}</span>
                  </div>
                  <div class="text-slate-700 dark:text-slate-300 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg p-4 prose prose-sm max-w-none border border-emerald-100 dark:border-emerald-800">
        ...
        <div class="space-y-4">
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
            <div class="flex items-start space-x-4">
              <div class="w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl flex items-center justify-center flex-shrink-0 mt-1">
      ...
      <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <!-- Blockers Section -->
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
          <div class="bg-gradient-to-r from-red-50 to-rose-50 dark:from-red-900/30 dark:to-rose-900/30 px-6 py-4 border-b border-red-100 dark:border-red-800">
            <div class="flex items-center space-x-2">
        ...
        <!-- Discussion Section -->
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
          <div class="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/30 dark:to-teal-900/30 px-6 py-4 border-b border-emerald-100 dark:border-emerald-800">
            <div class="flex items-center space-x-2">
