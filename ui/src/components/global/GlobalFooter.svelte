...
>
  ...
  <div class="absolute inset-0 opacity-5 dark:opacity-10">
    <div class="absolute inset-0" style="background-image: radial-gradient(circle at 25% 25%, rgba(99, 102, 241, 0.3) 0%, transparent 50%), radial-gradient(circle at 75% 75%, rgba(99, 102, 241, 0.2) 0%, transparent 50%);"></div>
  </div>
      ...
      <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 lg:gap-16">
        ...
        <div class="flex flex-col items-center lg:items-start space-y-4 lg:max-w-md">
          ...
          <div class="flex items-center space-x-2 rtl:space-x-reverse">
            <div class="flex items-center justify-center w-10 h-10 rounded-lg bg-gray-200 dark:bg-gray-800 transition-colors duration-300 group-hover:bg-indigo-100 dark:group-hover:bg-indigo-900/30">
        ...
        <div class="lg:flex-shrink-0">
          <h3 class="font-semibold text-gray-900 dark:text-white uppercase tracking-wider mb-4 text-center lg:text-start">
            Quick Links
          </h3>
          <nav>
