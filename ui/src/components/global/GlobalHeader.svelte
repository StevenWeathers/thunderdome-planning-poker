...
<header class="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 shadow-sm relative z-50">
      ...
      <div class="hidden lg:flex lg:items-center lg:space-x-1 font-rajdhani uppercase text-lg tracking-wide">
        {#if $user.name}
          <a
            ...
            class="{currentPage === 'dashboard' ? activePageClass : pageClass}"
          >
            Dashboard
          </a>
        {/if}
