...
>
  <div>
    ...
    {#if !showJiraCloudSearch}
      <div class="mb-8">
        <div class="bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-950/20 dark:to-blue-950/20 rounded-xl p-6 border border-indigo-100 dark:border-indigo-800/30">
            ...
            {#if !showGameImport && !showStoryboardImport}
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <HollowButton
                    ...
                    size="large"
                    color="purple"
                    onClick={toggleStoryboardImport}
                  >
    ...
    {#if !showGameImport && !showStoryboardImport}
      <!-- Jira Cloud Section -->
      <div class="mb-8">
        <div class="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-950/20 dark:to-cyan-950/20 rounded-xl p-6 border border-blue-100 dark:border-blue-800/30">
          <div class="flex items-center gap-3 mb-4">
      ...
      {#if !showJiraCloudSearch}
        <!-- File Import Section -->
        <div class="space-y-6">
          <div class="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20 rounded-xl p-6 border border-amber-100 dark:border-amber-800/30">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <!-- Jira XML Import -->
              <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 h-full flex flex-col">
