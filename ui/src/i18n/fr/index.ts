...
const fr: Translation = {
  ...
  flag: 'Indicateur',
  footerAuthoredBy: 'est conçu et développé par {authorOpen}Steven Weathers{authorClose}.',
  footerLicense: 'Le code source est sous licence {licenseOpen}Apache 2.0{licenseClose}.',
  forgotPassword: 'Mot de passe oublié ?',
  forgotPasswordSubtext: 'Ne vous inquiétez pas ! Entrez simplement votre mail et nous vous enverrons les instructions pour réinitialiser votre mot de passe.',
  ...
  landingFeatureOpenSourceText: 'Consultez le {repoOpen}dépôt Github{repoClose} pour demander ou contribuer à des améliorations, des traductions et des corrections de bugs ou pour {donateOpen}faire un don{donateClose}.',
  landingFeatureOpenSourceTitle: 'Open Source',
  landingSalesPitch: 'Collaboration d\'équipe à distance avec estimation de stories Agile, rétrospective de sprint, story mapping et enregistrement d\'équipe asynchrone.',
  ...
  mfaSetupIntro: 'Scannez le code QR suivant avec une application d\'authentification (tel que Google Authenticator ou Authy) puis entrez le jeton généré.',
  ...
  verifyAccountFailedError: 'Quelque chose s\'est mal passé lors de la vérification de votre compte, peut-être que ce lien a expiré ou a déjà été utilisé.',
  ...
  apiKeyCreateSuccess: 'Nouvelle clé API {keyName} créée, {onlyNowOpen}elle sera affichée uniquement maintenant{onlyNowClose}',
  apiKeyStoreWarning: 'Veuillez la stocker en lieu sûr car dès lors que vous quitterez cette page, nous ne pourrons plus récupérer ou restaurer cette clé générée.',
  ...
  addUserWillInviteNotFoundFieldNote: 'Si l\'utilisateur n\'est pas inscrit, une invitation à s\'inscrire et à rejoindre le {pageType} sera envoyée.',
  ...
  retroDescription: 'Une rétrospective de sprint est une revue effectuée après un sprint qui joue un rôle clé dans la méthodologie Agile. Une rétrospective de sprint vise à déterminer ce qui a bien fonctionné et où vous avez rencontré des problèmes, et à identifier les domaines où vous pouvez vous améliorer.',
  pokerDescription: 'Le poker planning est une façon ludique que les équipes de développement utilisent pour estimer l\'effort des tâches de gestion de projet. Ces estimations sont basées sur les contributions et le consensus de l\'ensemble du groupe, les rendant plus engageantes et précises que d\'autres méthodes.',
  storyboardDescription: 'Le user story mapping (storyboard) est une méthode de visualisation du parcours utilisateur effectué avec un produit, du début à la fin. Elle inclut toutes les tâches qu\'ils accompliraient typiquement dans le cadre de ce parcours.',
