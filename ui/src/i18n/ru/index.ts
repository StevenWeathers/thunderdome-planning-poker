...
const ru: Translation = {
  ...
  actionPhaseDescription:
    'Добавьте пункты действий, вы больше не можете группировать или голосовать за комментарии',
  actions: 'Действия',
  ...
  projectKeyValidationError:
    'Ключ проекта должен содержать 2-10 буквенно-цифровых символов',
  ...
  dashboardSubtitle:
    'Сделайте вашу следующую командную сессию по сотрудничеству самой лучшей.',
  ...
  dashboardTeamsRequired:
    'Выберите команду, чтобы увидеть ваши сессии planning poker, ретроспективы и storyboards.',
  ...
  trySelectingDifferentTeamForPoker:
    'Попробуйте выбрать другую команду или создать новую игру',
  ...
  trySelectingDifferentTeamForRetros:
    'Попробуйте выбрать другую команду или создать новую ретроспективу',
