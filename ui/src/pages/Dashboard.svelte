                  ...
                  <div class="py-2">
                    ...
                    >
                      <div class="flex items-center space-x-3">
                        ...
                        <div class="text-left">
                          <div class="font-medium">All Teams</div>
                          <div
            ...
            {:else}
              <div class="text-center py-16">
                ...
                <p class="text-xl text-slate-600 dark:text-slate-400 mb-2">
                  {selectedTeam
                    ? `No games found for ${selectedTeam.name}`
                    : $LL.noGamesFound()}
                </p>
          ...
          <section>
            ...
            {:else}
              <div class="text-center py-16">
                ...
                <p class="text-xl text-slate-600 dark:text-slate-400 mb-2">
                  {selectedTeam
                    ? `No retros found for ${selectedTeam.name}`
                    : $LL.noRetrosFound()}
                </p>
                <p class="text-sm text-slate-500 dark:text-slate-500">
                  {selectedTeam
                    ? 'Try selecting a different team or schedule a new retro'
                    : 'Schedule your first retrospective meeting'}
                </p>
              </div>
            {/if}
          </section>
          ...
          <section>
                    ...
                    >
                      <div class="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <div class="text-sm text-gray-500 dark:text-gray-400">
                            {storyboardCount} total storyboards
                          </div>
                        </div>
                      </div>
                      <ArrowRight
            ...
            {:else}
              <div class="text-center py-16">
                ...
                <p class="text-xl text-slate-600 dark:text-slate-400 mb-2">
                  {selectedTeam
                    ? `No storyboards found for ${selectedTeam.name}`
                    : 'No storyboards found'}
                </p>
                <p class="text-sm text-slate-500 dark:text-slate-500">
                  {selectedTeam
                    ? 'Try selecting a different team or create a new storyboard'
                    : 'Start planning visually with storyboards'}
                </p>
              </div>
            {/if}
          </section>
