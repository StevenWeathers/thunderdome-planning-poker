...
- As the server-wide `CONFIG_AVATAR_SERVICE` setting - all users will have initials avatars with no configuration options
- As a user-selectable option within other avatar services (gravatar, robohash, govatar) - users can choose `none` from their profile dropdown
