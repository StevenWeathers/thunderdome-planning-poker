...
func (s *server) routes() {
	...
	s.router.HandleFunc("/api/organization/{orgId}/department/{departmentId}", s.userOnly(s.handleGetDepartmentByUser())).Methods("GET")
	s.router.HandleFunc("/api/organization/{orgId}/teams", s.userOnly(s.handleCreateOrganizationTeam())).Methods("POST")
	...
	s.router.HandleFunc("/api/organization/{orgId}/users", s.userOnly(s.handleOrganizationAddUser())).Methods("POST")
	s.router.HandleFunc("/api/organization/{orgId}", s.userOnly(s.handleGetOrganizationByUser())).Methods("GET")
	// departments(s)
	s.router.HandleFunc("/api/department/{departmentId}/teams/{limit}/{offset}", s.userOnly(s.handleGetDepartmentTeams())).Methods("GET")
	...
	s.router.HandleFunc("/api/department/{departmentId}/users", s.userOnly(s.handleDepartmentAddUser())).Methods("POST")
	// teams(s)
	...
	s.router.HandleFunc("/api/team/{teamId}/users", s.userOnly(s.handleTeamAddUser())).Methods("POST")
	// teams(s)
	// admin routes
