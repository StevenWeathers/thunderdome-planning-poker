...
func (s *server) routes() {
	...
	s.router.HandleFunc("/api/organization/{orgId}/department/{departmentId}/team/{teamId}/battles", s.userOnly(s.departmentTeamAdminOnly(s.handleTeamRemoveBattle()))).Methods("DELETE")
	...
	s.router.HandleFunc("/api/organization/{orgId}/team/{teamId}/battles", s.userOnly(s.orgTeamAdminOnly(s.handleTeamRemoveBattle()))).Methods("DELETE")
	...
	s.router.HandleFunc("/api/team/{teamId}/battles", s.userOnly(s.teamAdminOnly(s.handleTeamRemoveBattle()))).Methods("DELETE")
