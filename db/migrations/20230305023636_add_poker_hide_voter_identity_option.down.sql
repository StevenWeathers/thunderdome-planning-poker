ALTER TABLE battles DROP COLUMN hide_voter_identity;
...
DROP FUNCTION team_create_battle(teamid uuid, leaderid uuid, battlename character varying, pointsallowed jsonb, autovoting boolean, pointaveragerounding character varying, hidevoteridentity bool, joincode text, leadercode text, OUT battleid uuid);
